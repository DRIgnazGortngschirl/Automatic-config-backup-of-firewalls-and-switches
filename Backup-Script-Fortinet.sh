...
do
    echo -e "Host found in hostfile \e[35m$device\e[39m" &>> Log/log$date.txt
    scp -i ./SSH-Keys/Backup-SSH-Key $device:sys_config ./BackupConfigFortinet &>> Log/log$date.txt # Will copy to all devices in "Fortinet-Devices.txt" and copy it secure localy
